/*
  ...
  1. New Tables
    - `n8n_generations_resume` - Stores resume generations from N8N workflow
    - `n8n_generations_cover_letter` - Stores cover letter generations from N8N workflow
...
DECLARE
    r RECORD;
BEGIN
    -- Drop all policies on n8n_generations_resume
    ...
    -- Drop all policies on n8n_generations_cover_letter
